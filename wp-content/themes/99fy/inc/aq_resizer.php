...
if(!class_exists('nnfy_Aq_Resize')) {
    class Aq_Exception extends Exception {}

    class nnfy_Aq_Resize
    {
        /**
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                error_log('nnfy_Aq_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('nnfy_aq_resize')) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function nnfy_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        ...
        $nnfy_aq_resize = nnfy_Aq_Resize::getInstance();
        return $nnfy_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}
