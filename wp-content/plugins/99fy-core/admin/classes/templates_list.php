<div class="httemplates-templates-area">
        ...
        <div class="httemplate-popupcontent">
            ...
            <div class="htwptpopupcontent">
                ...
                <div class="htpageimportarea">
                    ...
                    <input id="htwptpagetitle" type="text" name="htwptpagetitle" placeholder="<?php echo esc_attr_x( 'Enter a Page Name', 'placeholder', '99fy' ); ?>">
                    ...
                    <div class="col-md-auto col">
                        <div class="htwpt-demos-select">
                            <select id="htwpt-demos">
                                <option value="templates"><?php esc_html_e( 'Templates', '99fy' ); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-auto col">
                        <div class="htwpt-builder-select">
                            <select id="htwpt-builder">
                                <option value="all"><?php esc_html_e( 'All Builders', '99fy' ); ?></option>
                                <option value="elementor"><?php esc_html_e( 'Elementor', '99fy' ); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-auto mr-auto">
                        <input id="htwpt-search-field" type="text" placeholder="<?php esc_attr_e( 'Search..', '99fy' );?>">
                    </div>
                    <div class="col-auto">
                        <div class="htwpt-type-select">
                            <select id="htwpt-type">
                                <option value="all"><?php esc_html_e( 'ALL', '99fy' ); ?></option>
                                <option value="free"><?php esc_html_e( 'Free', '99fy' ); ?></option>
                                <option value="pro"><?php esc_html_e( 'Pro', '99fy' ); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
    ...
    <div id="htwpt-group-section">
        <div id="htwpt-group-bar" class="htwpt-group-bar">
            <span id="htwpt-group-close" class="back"><i>&#8592;</i> <?php esc_html_e( 'Back to Library', '99fy' ); ?></span>
            <h3 id="htwpt-group-name" class="title"></h3>
        </div>

        <div id="htwpt-group-grid" class="row"></div>
        <a href="#top" class="htwpt-groupScrollToTop"><?php echo esc_html__( 'Top', '99fy' );?></a>
    </div>

    <a href="#top" class="htwpt-scrollToTop"><?php echo esc_html__( 'Top', '99fy' );?></a>
