...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var icon_value = jQuery(this).find('.nnfypro-icon-select').val();
...
jQuery(document).ready(function ($) {
	nnfypro_icon_picker_init();
	function nnfypro_icon_picker_init(){
		icon_picker = jQuery('select.nnfypro-icon-select').fontIconPicker({
			emptyIcon:false,
			iconsPerPage:25,
		});
	}
    ...
    theme_conrols.on('change', '.nnfypro-icon-select',function(){
        customizer_repeater_refresh_general_control_values();
        return false;
    });
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.nnfypro-icon-select').val('');
